...
[![CircleCI](https://circleci.com/gh/maximelafarie/humand/tree/develop.svg?style=svg)](https://circleci.com/gh/maximelafarie/humand)
![License](https://poser.pugx.org/biig/domain/license)
...
```
echo '127.0.0.1 humand.test pma.humand.test api.humand.test maildev.humand.test' | sudo tee -a /etc/hosts
```
